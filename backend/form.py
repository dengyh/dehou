...
class adminForm(forms.Form):
	username = forms.CharField(max_length=20,required=True,error_messages={'required':u'管理员名称不能为空'})
	first_name = forms.CharField(max_length=20,required=True,error_messages={'required':u'账号不能为空'})
